            ...
            <div className="doc-tablewrapper">
                <table className="doc-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>border-start-none</td>
                            <td>border-inline-start-width: 0px;</td>
                        </tr>
                        <tr>
                            <td>border-start-1</td>
                            <td>border-inline-start-width: 1px;</td>
                        </tr>
                        <tr>
                            <td>border-start-2</td>
                            <td>border-inline-start-width: 2px;</td>
                        </tr>
                        <tr>
                            <td>border-start-3</td>
                            <td>border-inline-start-width: 3px;</td>
                        </tr>
                        <tr>
                            <td>border-end-none</td>
                            <td>border-inline-end-width: 0px;</td>
                        </tr>
                        <tr>
                            <td>border-end-1</td>
                            <td>border-inline-end-width: 1px;</td>
                        </tr>
                        <tr>
                            <td>border-end-2</td>
                            <td>border-inline-end-width: 2px;</td>
                        </tr>
                        <tr>
                            <td>border-end-3</td>
                            <td>border-inline-end-width: 3px;</td>
                        </tr>
                    </tbody>
                </table>
            </div>

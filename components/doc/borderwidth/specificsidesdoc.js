...
export function SpecificSidesDoc(props) {
    ...
    <div class="border-end-2 border-primary-500 w-12rem h-6rem m-2 surface-overlay font-bold flex align-items-center justify-content-center">border-end-2</div>
    ...
    <div class="border-start-2 border-primary-500 w-12rem h-6rem m-2 surface-overlay font-bold flex align-items-center justify-content-center">border-start-2</div>
</div>
`;
        ...
        <>
            ...
            <div className="card">
                <div className="flex flex-wrap md:justify-content-between justify-content-center">
                    ...
                    <div className="border-end-2 border-primary-500 w-12rem h-6rem m-2 surface-overlay font-bold flex align-items-center justify-content-center">border-end-2</div>
                    ...
                    <div className="border-start-2 border-primary-500 w-12rem h-6rem m-2 surface-overlay font-bold flex align-items-center justify-content-center">border-start-2</div>
                </div>
            </div>
